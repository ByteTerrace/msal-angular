...
import { MsalBroadcastService, MsalInterceptor, MsalInterceptorConfiguration, MsalModule, MsalService } from '../public-api';
...
function initializeMsal() {
    ...
    TestBed.configureTestingModule({
        imports: [
            ...
            RouterTestingModule,
            MsalModule.forRoot(MSALInstanceFactory(), null as any, MSALInterceptorFactory())
        ],
        providers: [
            MsalInterceptor,
            MsalService,
...
function MSALInterceptorFactory(): MsalInterceptorConfiguration {
    return {
        ...
        protectedResourceMap: new Map([
            ...
            ["http://localhost:3000/unprotect", null as any],
